...
# ===== Popup for Product Name using pymsgbox =====
product_name = pymsgbox.prompt('Enter Product Name:', 'Product Name Input')
if not product_name:
...
driver.get("https://softwaredevelopmentsolution.com/Inventory/Products/Create")
...
try:
    ...
    print(f"Login not required or already logged in: {e}")
...
# Step 1: Add Name
try:
    wait.until(EC.presence_of_element_located((By.ID, "pRODUCT_NAME"))).send_keys(product_name)
    print("Name added successfully")
except Exception as e:
    print(f"Error in Step 1 (Name): {e}")
